...
export function HomeCommunityPartners() {
  return (
    <section
      className="reveal-on-scroll border-b border-stone-900/10 bg-ivory"
      aria-labelledby="community-partners-heading"
    >
      <Container className="py-16 sm:py-20 lg:py-24">
        <div className="grid min-w-0 grid-cols-1 items-center gap-12 overflow-x-clip lg:grid-cols-2 lg:items-start lg:gap-x-16 lg:gap-y-0 xl:gap-x-20 2xl:gap-x-24">
          {/*
          ...
          */}
          <div className="order-2 flex w-full min-w-0 max-w-full flex-col [container-type:inline-size] max-lg:mx-auto lg:order-1 lg:justify-end lg:pr-2 xl:pr-6">
            <div className="flex w-full justify-center lg:justify-end 2xl:justify-center">
              <CommunityPartnersOrbit />
            </div>
          </div>
          <header className="order-1 min-w-0 text-center max-lg:mx-auto max-lg:max-w-xl lg:order-2 lg:pl-2 lg:text-left xl:pl-0">
